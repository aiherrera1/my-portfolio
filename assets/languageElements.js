export const elements = [
  ...
  {
    id: "vis-info",
    en: "Visualization of Information",
    es: "Visualización de Información",
  },
  { id: "ai", en: "Artificial Intelligence", es: "Inteligencia Artificial" },
  {
    id: "daa",
    en: "Design and Analysis of Algorithms",
    es: "Diseño y Análisis de Algoritmos",
  },
  {
  ...
  {
    id: "blackjack-cardcounter",
    en: "Blackjack Card Counter",
    es: "Contador de Cartas de Blackjack",
  },

  {
    id: "blackjack-cardcounter-desc",
    en: "Created a blackjack card counter using Python and probability theory to update the perfect play strategy based on the remaining cards in the deck.",
  ...
  },
  {
    ...
    es: "Tecnologías Frontend",
  },
  { id: "backend-tech", en: "Backend Technologies", es: "Tecnologías Backend" },
  { id: "databases", en: "Databases", es: "Bases de Datos" },
  {
    id: "devops",
  ...
  { id: "tools", en: "Tools & Frameworks", es: "Herramientas y Frameworks" },
];
